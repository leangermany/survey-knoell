...
public class SurveyAlreadySubmittedView extends VerticalLayout {
	...
	private final Paragraph cause = new Paragraph("The survey was already submitted.");

	public SurveyAlreadySubmittedView() {
