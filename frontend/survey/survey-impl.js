...
class SurveyImpl extends LitElement {
    ...
    render() {
        return html `<div part='renderTarget' style='width: 100%; height: 100%; min-height: 500px;' id=${this.id}></div>`;
    }
    createRenderRoot() {
        return this;
    }
...
customElements.define('survey-impl', SurveyImpl);